...
<head>
    ...
    <!-- my style-->
    <link rel="stylesheet" href="<?php getThemeFile("css/myTypecho.css", true) ?>">
    ...
    <script>(function(){
        ...
        lsloader.clean=function(){
            try{
                var b=[];for(var a=0;a<localStorage.length;a++){
